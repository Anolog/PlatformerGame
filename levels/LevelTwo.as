package levels 
{
	...
	{
		[Embed(source = "../data/leveldata/mapCSV_1.2_Level1.csv", mimeType = "application/octet-stream")] private var csv:Class;
		[Embed(source = "../data/leveldata/mapCSV_1.2_Decorations.csv", mimeType = "application/octet-stream")] private var decorationsCSV:Class;
		[Embed(source = "../data/leveldata/mapCSV_1.2_Objects.csv", mimeType = "application/octet-stream")] private var objectsCSV:Class;
		[Embed(source = "../data/leveldata/mapCSV_1.2_Enemies.csv", mimeType = "application/octet-stream")]private var enemiesCSV:Class;
